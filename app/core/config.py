...
class Settings:
    def __init__(self):
        # MongoDB Database
        self.MONGODB_URL: str = os.getenv("MONGODB_URL", "mongodb+srv://bu22-2130:bu22-2130@cluster0.4nsgp2g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&ssl=true&ssl_cert_reqs=CERT_NONE")
