...
# CORS middleware - Configure for Cloudflare deployment
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
...
async def health_check():
    return {"status": "healthy", "message": "Smart Campus App is running on Cloudflare"}
...
# For Cloudflare Pages, we don't need the uvicorn.run() call
# The app will be served by Cloudflare's infrastructure
